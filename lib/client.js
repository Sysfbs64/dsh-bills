    ...
    function BillsPage(props) {
      ...
      return React.createElement('div', { className: 'bills-page' },
        ...
        React.createElement('div', { className: 'bills-foot' },
          ...
          React.createElement('br', null),
          '· ' + (pricing.peakLabel || '') + '；空闲时段价格为高峰的一半，峰谷定价于 ' + (pricing.effectiveLabel || '2026-08-16 16:00 UTC') + ' 生效，生效前的调用按当时官方价计费。',
          pricing.latestLabel ? React.createElement('br', null) : null,
          pricing.latestLabel ? '· ' + pricing.latestLabel : null,
          React.createElement('br', null),
